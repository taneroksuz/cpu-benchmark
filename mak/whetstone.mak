...
RISCV_GCC ?= $(RISCV)gcc
RISCV_GCC_OPTS ?= -march=$(ARCH) -mabi=$(ABI) -DRISCV -O2 -fno-common -funroll-loops -finline-functions -funroll-all-loops -falign-functions=8 -falign-jumps=8 -falign-loops=8 -finline-limit=1000 -mtune=sifive-7-series -ffast-math -fno-tree-loop-distribute-patterns --param fsm-scale-path-stmts=3 -Wno-implicit -Wno-stringop-overflow
